...
# - On Ubuntu, I have GNU grep. This means that I can use extended regular expression (ERE) syntax by default
...
use_positive_lookahead_with_pcre() {
    # - With the -P flag, PCRE syntax matches "remram" from the line: "https://remram44.github.io/regex-cheatsheet/regex.html - regular expression
    #   syntax comparison"
