...
# - Word splitting is not done on variable expansions during an assignment expressionso
...
# - To reinforce this point, this shows that word splitting is not performed with command substitution in an assignment expression because command
#   substitution is a type of variable expansion
