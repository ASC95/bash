...
braces_separate_variable_names() {
    ...
    printf '%s\n' "A ${type}Error was raised during execution"
}
...
# Braces appear to be required to perform indirect variable expansion. Indirect variable expansion uses the expansion of one variable to form the name
# of another variable that will also be expanded
...
braces_allow_indirect_expansion() {
    ...
    kitty_cat="Boots"
    printf '%s\n' "The cat's name is ${!kitty*}" # Double indirection is hard
}
