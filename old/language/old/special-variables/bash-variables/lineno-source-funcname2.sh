...
# If this file is sourced, the output is:
# BASH_LINENO[0]: 92
# BASH_LINENO[1]: 24 # this value varies
# BASH_LINENO[2]:
# BASH_LINENO[3]:
# BASH_LINENO[4]:
# BASH_LINENO[5]:
...
# FUNCNAME[4]:
# FUNCNAME[5]:
# BASH_SOURCE[0]: bashlineno-bashsource-funcname.sh # these paths both vary depending on the directory from which "." was executed
